...
Смонтировать S3-совместимое хранилище в Pod `message-service` как файловую систему по пути `/uploads`.
...
2. Внутри контейнера есть каталог `/uploads`, смонтированный через CSI.
